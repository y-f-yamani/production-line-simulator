...
assert.match(html, /<title>Production Line Simulator V1<\/title>/);
assert.match(html, /<meta name="application-name" content="Production Line Simulator V1" \/>/);
...
assert.match(html, /<h1>Production Line Simulator V1<\/h1>/);
